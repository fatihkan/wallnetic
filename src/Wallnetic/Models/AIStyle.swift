...
enum StyleCategory: String, CaseIterable {
    case nature = "Nature & Landscapes"
    case artistic = "Artistic"
    case dark = "Dark & Moody"
    case retro = "Retro & Vintage"
    case scifi = "Sci-Fi & Fantasy"
    case abstract = "Abstract & Patterns"
}
...
struct AIStyle: Identifiable, Hashable {
    ...
    static let allStyles: [AIStyle] = [
        // Nature
        .nature, .tropical, .aurora, .space,
        // Artistic
        .anime, .watercolor, .ukiyoe, .surreal, .realistic,
        // Dark
        .noir, .gothic,
        // Retro
        .vaporwave, .vintage, .steampunk,
        // Sci-Fi
    ...
    static var stylesByCategory: [StyleCategory: [AIStyle]] {
        Dictionary(grouping: allStyles, by: { $0.category })
    }
